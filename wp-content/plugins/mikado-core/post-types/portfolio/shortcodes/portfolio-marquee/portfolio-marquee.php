...
class PortfolioMarquee implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if(function_exists('vc_map')) {
			vc_map(array(
					'name'                      => esc_html__('Portfolio Marquee', 'mkd-core'),
					'base'                      => $this->base,
					...
					'params'                    => array_merge(
						array(
							...
							array(
								'type'        => 'dropdown',
								'heading'     => esc_html__('Shift duration', 'mkd-core'),
								'admin_label' => true,
								'param_name'  => 'autoplay',
								'group'       => esc_html__('Layout Options', 'mkd-core'),
								'value'       => array(
								...
								'save_always' => true,
								'description' => esc_html__('Time in seconds between two shifts', 'mkd-core'),
							),
							array(
								'type'        => 'dropdown',
								'heading'     => esc_html__('Enable Overlay on Hover', 'mkd-core'),
							...
							array(
								'type'        => 'dropdown',
								'heading'     => esc_html__('Open Portfolio Single in New Page', 'mkd-core'),
								'param_name'  => 'target',
								'group'       => esc_html__('Layout Options', 'mkd-core'),
								'value'       => array(
									esc_html__('Yes', 'mkd-core') => '_blank',
									esc_html__('No', 'mkd-core')  => '_self'
								),
								'admin_label' => true,
								'save_always' => true
							),
