...
class Carousel implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map(array(
			'name'                      => esc_html__('Carousel', 'mkd-core'),
			'base'                      => $this->base,
			...
			'params'                    => array(
				array(
					'type'        => 'dropdown',
					'heading'     => esc_html__('Carousel Slider', 'mkd-core'),
					'param_name'  => 'carousel',
				...
				array(
					...
					"holder"      => "div",
					"class"       => "",
					"heading"     => esc_html__("Number of Rows", 'mkd-core'),
				...
				array(
					'type'        => 'dropdown',
					'heading'     => esc_html__('Enable border between items', 'mkd-core'),
					'param_name'  => 'border',
					'value'       => array(
						esc_html__('No', 'mkd-core')  => 'no',
						esc_html__('Yes', 'mkd-core') => 'yes',
	...
	public function render($atts, $content = null) {
		...
		if($carousel !== '') {
			...
			$html .= '<div class="mkd-carousel " '.medigroup_mikado_get_inline_attrs($carousel_data_attributes).'>';
