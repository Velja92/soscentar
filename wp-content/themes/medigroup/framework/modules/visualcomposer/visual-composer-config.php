...
if(!function_exists('medigroup_mikado_configure_visual_composer')) {
	/**
	 * Configuration for Visual Composer
	 * Hooks on vc_after_init action
	 */
	function medigroup_mikado_configure_visual_composer() {
	...
	add_action('vc_after_init', 'medigroup_mikado_configure_visual_composer');

}


if(!function_exists('medigroup_mikado_configure_visual_composer_grid_elemets')) {
	...
	function medigroup_mikado_configure_visual_composer_grid_elemets() {
	...
	add_action('vc_after_init', 'medigroup_mikado_configure_visual_composer_grid_elemets');
}


if(!function_exists('medigroup_mikado_configure_visual_composer_frontend_editor')) {
	/**
	 * Configuration for Visual Composer FrontEnd Editor
	 * Hooks on vc_after_init action
	 */
	function medigroup_mikado_configure_visual_composer_frontend_editor() {
	...
	add_action('vc_after_init', 'medigroup_mikado_configure_visual_composer_frontend_editor');
}
...
if(class_exists('WPBakeryShortCodesContainer')) {
	...
	class WPBakeryShortCode_Mkd_Cover_Boxes extends WPBakeryShortCodesContainer {
	}

	class WPBakeryShortCode_Mkd_Cover_Box extends WPBakeryShortCodesContainer {
	}

	class WPBakeryShortCode_Mkd_Info_List extends WPBakeryShortCodesContainer {
	}
...
/*** Row ***/
if(!function_exists('medigroup_mikado_vc_row_map')) {
	/**
	 * Map VC Row shortcode
	 * Hooks on vc_after_init action
	 */
	function medigroup_mikado_vc_row_map() {

		$animations = array(
			esc_html__('No animation', 'medigroup')                    => '',
			esc_html__('Elements Shows From Left Side', 'medigroup')   => 'mkd-element-from-left',
			esc_html__('Elements Shows From Right Side', 'medigroup')  => 'mkd-element-from-right',
			esc_html__('Elements Shows From Top Side', 'medigroup')    => 'mkd-element-from-top',
			esc_html__('Elements Shows From Bottom Side', 'medigroup') => 'mkd-element-from-bottom',
			esc_html__('Elements Shows From Fade', 'medigroup')        => 'mkd-element-from-fade'
		);

		vc_add_param('vc_row', array(
			'type'       => 'dropdown',
			'class'      => '',
			'heading'    => esc_html__('Row Type', 'medigroup'),
			'param_name' => 'row_type',
			'value'      => array(
				esc_html__('Row', 'medigroup')      => 'row',
				esc_html__('Parallax', 'medigroup') => 'parallax'
			)
		));
		...
		vc_add_param('vc_row', array(
			'type'       => 'dropdown',
			'class'      => '',
			'heading'    => esc_html__('Content Width', 'medigroup'),
			'param_name' => 'content_width',
			'value'      => array(
				esc_html__('Full Width', 'medigroup') => 'full-width',
				esc_html__('In Grid', 'medigroup')    => 'grid'
			)
		));
		...
		vc_add_param('vc_row', array(
			'type'       => 'dropdown',
			'class'      => '',
			'heading'    => esc_html__('Header Style', 'medigroup'),
			'param_name' => 'header_style',
			'value'      => array(
				esc_html__('Default', 'medigroup') => '',
				esc_html__('Light', 'medigroup')   => 'mkd-light-header',
				esc_html__('Dark', 'medigroup')    => 'mkd-dark-header'
			),
		...
		vc_add_param('vc_row', array(
			'type'        => 'textfield',
			'class'       => '',
			'heading'     => esc_html__('Anchor ID', 'medigroup'),
			'param_name'  => 'anchor',
			'value'       => '',
			'description' => esc_html__('For example "home"', 'medigroup')
		));
		vc_add_param('vc_row', array(
			'type'       => 'dropdown',
			'class'      => '',
			'heading'    => esc_html__('Content Aligment', 'medigroup'),
		...
		vc_add_param('vc_row', array(
			'type'        => 'dropdown',
			'class'       => '',
			'heading'     => esc_html__('Video Background', 'medigroup'),
			'value'       => array(
				esc_html__('No', 'medigroup')  => '',
				esc_html__('Yes', 'medigroup') => 'show_video'
			),
			'param_name'  => 'video',
			'description' => '',
		...
		vc_add_param('vc_row', array(
			'type'        => 'dropdown',
			'class'       => '',
			'heading'     => esc_html__('Video Overlay', 'medigroup'),
			'value'       => array(
				esc_html__('No', 'medigroup')  => '',
				esc_html__('Yes', 'medigroup') => 'show_video_overlay'
			),
		...
		vc_add_param('vc_row', array(
			'type'        => 'attach_image',
			'class'       => '',
			'heading'     => esc_html__('Video Overlay Image (pattern)', 'medigroup'),
			'value'       => '',
		...
		vc_add_param('vc_row', array(
			'type'        => 'textfield',
			'class'       => '',
			'heading'     => esc_html__('Video Background (webm) File URL', 'medigroup'),
			'value'       => '',
		...
		vc_add_param('vc_row', array(
			'type'        => 'textfield',
			'class'       => '',
			'heading'     => esc_html__('Video Background (mp4) file URL', 'medigroup'),
			'value'       => '',
		...
		vc_add_param('vc_row', array(
			'type'        => 'textfield',
			'class'       => '',
			'heading'     => esc_html__('Video Background (ogv) file URL', 'medigroup'),
			'value'       => '',
		...
		vc_add_param('vc_row', array(
			'type'        => 'attach_image',
			'class'       => '',
			'heading'     => esc_html__('Video Preview Image', 'medigroup'),
			'value'       => '',
		...
		vc_add_param("vc_row", array(
			'type'        => 'dropdown',
			'class'       => '',
			'heading'     => esc_html__('Full Screen Height', 'medigroup'),
		...
		vc_add_param('vc_row', array(
			'type'       => 'dropdown',
			'class'      => '',
			'heading'    => esc_html__('Vertically Align Content In Middle', 'medigroup'),
		...
		vc_add_param('vc_row', array(
			'type'       => 'textfield',
			'class'      => '',
			'heading'    => esc_html__('Section Height', 'medigroup'),
		...
		vc_add_param('vc_row', array(
			'type'        => 'attach_image',
			'class'       => '',
			'heading'     => esc_html__('Parallax Background image', 'medigroup'),
			'value'       => '',
			'param_name'  => 'parallax_background_image',
			'description' => esc_html__('Please note that for parallax row type, background image from Design Options will not work so you should to fill this field', 'medigroup'),
			'dependency'  => Array('element' => 'row_type', 'value' => array('parallax'))
		));
		...
		vc_add_param('vc_row', array(
			'type'       => 'textfield',
			'class'      => '',
			'heading'    => esc_html__('Parallax speed', 'medigroup'),
		...
		vc_add_param('vc_row', array(
			'type'        => 'dropdown',
			'heading'     => esc_html__('CSS Animation', 'medigroup'),
		...
		vc_add_param('vc_row', array(
			'type'        => 'textfield',
			'heading'     => esc_html__('Transition delay (ms)', 'medigroup'),
	...
	add_action('vc_after_init', 'medigroup_mikado_vc_row_map');
}
